describe('Web Automation', function () {
   it('Verify UI layer by mocking json response object', function () {
        ...
        cy.intercept('GET', '/api/accommodation/property/details**', { fixture: 'apiHandler/mock_amenities_MoreData.json' }).as('mockSearch');
        ...
        cy.get('[data-testid="propertyDetails_seeAllAmenitiesClick"]').should('be.visible');
